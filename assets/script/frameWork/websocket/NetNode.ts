...
export class NetNode {
    ...
    public closeSocket(code?: number, reason?: string) {
        ...
        this.rejectReconnect();//5.14 ---sun(关闭后不再重连)
    }
    ...
    protected resetHearbeatTimer() {
        ...
        //     // console.log("NetNode keepAliveTimer send Hearbeat" + this._protocolHelper.getHearbeat())
    ...
    public isAutoReconnect() {
        console.log("重连状态", this._autoReconnect);
