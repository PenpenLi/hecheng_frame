...
import { uiFormType, uiFormPath, UI_CONFIG_NAME } from "../common/config/gameConfigs";
...
export default class DlgXianshFhView extends baseUi {
    ...
    btnStartCJ() {
        //给服务器发消息
        if (cfgManager.ins().gameManager.getEmpty()) {
            this.actionOfStart();
    ...
    sendMessageFIVE() {
        ...
        cfgManager.ins().http.sendRequest('/portal/game/breakerCompose', null, funSuc, funErr);
    }
    ...
    rewardXsChongwu(index: number) {
        switch (Number(index)) {
            case 0://30分钟
                cfgManager.ins().gameManager.addBird(47, 3, 1800);
                break;
            case 1://60分钟
                cfgManager.ins().gameManager.addBird(47, 3, 3600);
                break;
            case 2://1天
                cfgManager.ins().gameManager.addBird(47, 3, 86400);
                break;
            case 3://3天
                cfgManager.ins().gameManager.addBird(47, 3, 259200);
                break;
            case 4://5天
                cfgManager.ins().gameManager.addBird(47, 3, 432000);
                break;
            case 5://10天
                cfgManager.ins().gameManager.addBird(47, 3, 864000);
                break;
            case 6://30天
                cfgManager.ins().gameManager.addBird(47, 3, 2592000);
                break;
            case 7://永久
